...
//  MeUniversal
//
//  Created by YanHang on 2018/6/28.
...
@interface FeatureViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
       ...
       [_collectionView registerClass:[FeatureCollectionViewCell class] forCellWithReuseIdentifier:DCNewFeatureCellID];
    }
...
- (UIButton *)skipButton
{
    ...
    if (_skipButton == nil) {
        ...
        _skipButton = [UIButton buttonWithType:(UIButtonType)UIButtonTypeCustom];
...
{
    FeatureCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:DCNewFeatureCellID forIndexPath:indexPath];
    cell.imageName = (iPhoneX) ? [NSString stringWithFormat:@"%@_x",_imageArray[indexPath.row]]  : _imageArray[indexPath.row];
    ...
    cell.hideButtonClickBlock = ^{
        ...
        [weakSelf restoreRootViewController:[[TabBarController alloc] init]];
    };
